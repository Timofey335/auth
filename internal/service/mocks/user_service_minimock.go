...
type UserServiceMockGetRefreshTokenExpectation struct {
	...
	expectationOrigins UserServiceMockGetRefreshTokenExpectationOrigins
...
// UserServiceMockGetRefreshTokenOrigins contains origins of expectations of the UserService.GetRefreshToken
type UserServiceMockGetRefreshTokenExpectationOrigins struct {
	origin      string
	originCtx   string
	originToken string
}
...
func (mmGetRefreshToken *mUserServiceMockGetRefreshToken) ExpectTokenParam2(token string) *mUserServiceMockGetRefreshToken {
	...
	mmGetRefreshToken.defaultExpectation.expectationOrigins.originToken = minimock.CallerInfo(1)
...
func (mmGetRefreshToken *mUserServiceMockGetRefreshToken) When(ctx context.Context, token string) *UserServiceMockGetRefreshTokenExpectation {
	...
	expectation := &UserServiceMockGetRefreshTokenExpectation{
		...
		expectationOrigins: UserServiceMockGetRefreshTokenExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
// GetRefreshToken implements mm_service.UserService
func (mmGetRefreshToken *UserServiceMock) GetRefreshToken(ctx context.Context, token string) (s1 string, err error) {
	...
	if mmGetRefreshToken.GetRefreshTokenMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetRefreshToken.t.Errorf("UserServiceMock.GetRefreshToken got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.token != nil && !minimock.Equal(*mm_want_ptrs.token, mm_got.token) {
				mmGetRefreshToken.t.Errorf("UserServiceMock.GetRefreshToken got unexpected parameter token, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetRefreshToken.GetRefreshTokenMock.defaultExpectation.expectationOrigins.originToken, *mm_want_ptrs.token, mm_got.token, minimock.Diff(*mm_want_ptrs.token, mm_got.token))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetRefreshToken.t.Errorf("UserServiceMock.GetRefreshToken got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *UserServiceMock) MinimockGetRefreshTokenInspect() {
	for _, e := range m.GetRefreshTokenMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UserServiceMock.GetRefreshToken at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.GetRefreshTokenMock.invocationsDone() && afterGetRefreshTokenCounter > 0 {
		m.t.Errorf("Expected %d calls to UserServiceMock.GetRefreshToken at\n%s but found %d calls",
...
func (mmLogin *mUserServiceMockLogin) ExpectUserLoginDataParam2(userLoginData *model.UserLoginModel) *mUserServiceMockLogin {
	...
	mmLogin.defaultExpectation.expectationOrigins.originUserLoginData = minimock.CallerInfo(1)
	...
	if mmLogin.LoginMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userLoginData != nil && !minimock.Equal(*mm_want_ptrs.userLoginData, mm_got.userLoginData) {
				mmLogin.t.Errorf("UserServiceMock.Login got unexpected parameter userLoginData, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmLogin.LoginMock.defaultExpectation.expectationOrigins.originUserLoginData, *mm_want_ptrs.userLoginData, mm_got.userLoginData, minimock.Diff(*mm_want_ptrs.userLoginData, mm_got.userLoginData))
			}
