...
test:
	go clean -testcache
	go test ./... -coverprofile=coverage.tmp.out -covermode count -coverpkg=github.com/Timofey335/auth/internal/service/...,github.com/Timofey335/auth/internal/api/... -count 5
